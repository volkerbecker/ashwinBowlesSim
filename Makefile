CLFLAGS = -DCL_USE_DEPRECATED_OPENCL_2_0_APIS -D__CL_ENABLE_EXCEPTIONS -DCL_ENABLE_EXCEPTIONS -std=c++11 -g

INCLUDE =-I${HOME}/workspace/openGLvisualizer -I${AMDAPPSDKROOT}/include/

OBJS =	ashwinBowles.o ParticleSystem.o Walls.o	AshwinBowlesSystem.o
